...
func (t *Transaction) trace(started time.Time, query string, args ...interface{}) {
	var margs = argsString(args...)
	t.logger.Printf("%s%s [%s] (%v)", t.dbmap.logPrefix, query, margs, (time.Now().Sub(started)))
}
